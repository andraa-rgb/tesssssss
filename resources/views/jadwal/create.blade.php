...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-base-content/70 mt-1">Isi form di bawah untuk menambahkan jadwal</p>
    </div>
            ...
            <form method="POST" action="{{ route('jadwal.store') }}">
                ...
                <div class="form-control mt-4">
                    ...
                    <textarea name="keterangan" rows="4" 
                              ...
                              placeholder="Deskripsi singkat tentang kegiatan ini...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <label class="label">
                            <span class="label-text-alt text-error">{{ $message }}</span>
                        </label>
